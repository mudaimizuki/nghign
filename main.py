...
def safe_rerun():
    ...
    st.stop() # Chặn đứng luồng thực thi để chống lỗi văng app
...
questions = [
    ...
    {"q": "Khai triển biểu thức x²(3x-2)⁵ ta nhận được bao nhiêu số hạng?", "options": ["A. 5", "B. 7", "C. 8", "D. Không đáp án nào đúng"], "answer": 3},
...
# ====================== TRANG CHƠI CHÍNH ======================
    ...
    # Bảo vệ index out of bounds siêu chặt chẽ
    ...
    # Progress Bar an toàn
    progress_val = min(q_idx / 10.0, 1.0)
...
# ====================== KẾT QUẢ ======================
    ...
    with col2:
        st.markdown("""
        <div style='text-align: center; background: #2b1c09; padding: 20px; border-radius: 10px; border: 2px solid #d4af37; margin-bottom: 20px;'>
            <a href='https://forms.gle/JuZChBEuK8Q43aGj7' target='_blank' style='color: #00ffcc; font-size: 22px; font-weight: bold; text-decoration: none; text-shadow: 0 0 10px #00ffcc;'>
                📝 BẤM VÀO ĐÂY ĐỂ ĐÁNH GIÁ GAME
            </a>
            <br><br>
            <span style='color: #a5d6a7; font-size: 15px;'><i>(Nếu không bấm được, hãy copy link bên dưới)</i></span><br>
            <code style='color: #ffea00; font-size: 16px; background: rgba(0,0,0,0.5); padding: 5px;'>https://forms.gle/JuZChBEuK8Q43aGj7</code>
        </div>
        """, unsafe_allow_html=True)
